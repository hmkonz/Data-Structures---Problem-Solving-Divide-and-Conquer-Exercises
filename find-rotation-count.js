...
function findRotationCount(array) {
  // if 'array' only has one element OR the first element in 'array' < the last element in 'array', return 0 as the number of times the array has been rotated (no rotation can/did occur)
  ...
  while (leftIdx <= rightIdx) {
    ...
    // if 'middleVal' (the value of the element in the middle of the array) > 'middleVal +1' (the value of the element in 'array' to the right of 'middleVal'), return number of times the array has been rotated as 'middleIdx +1' (i.e for array=[6,7,8,1,2,3] and num=8, middleIdx=2 and middleVal=8. Since middleVal > middleVal + 1 (8 > 1) then the number of times the array has been rotated = index of 1 (middleVal + 1))
